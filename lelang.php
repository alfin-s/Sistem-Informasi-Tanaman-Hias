        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2>Ikuti Grup Lelang Kami di WhatsApp</h2>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="team-member">
              <div class="thumb-container">
                <img src="admin/upload/<?= $lelang['gambar_lelang']; ?>">
              ...
              <div class="down-content">
                <h4><?= $lelang['judul_lelang'] ?></h4>
                <span><?= $lelang['jam_lelang'] ?></span>
                <h6><?= $lelang['tanggal_lelang'] ?></h6>
                <br>
                  <form action="<?= $lelang['grupwa'] ?>">
                    <button class="btn btn-success">Join Grup </button>
                  </form>
